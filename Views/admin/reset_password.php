      ...
      <div class="container my-auto">
        <div class="row">
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            ...
            <?php endif; ?>
            <form method="post" action="<?php echo BASE_URL . 'admin/resetPassword/' . $data['token']; ?>">
                ...
                <div class="text-center">
                    <button type="submit" class="btn bg-gradient-primary w-100 my-4 mb-2">Restablecer Contraseña</button>
                </div>
            </form>
            </div>
                </div>
